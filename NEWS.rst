...
Latest
------
* Minor: Added the ``upgrade`` command, which upgrades the specified
  dependencies and the dependencies they pull in, while keeping the remaining
  dependencies at the version stored in the lock file.
