...
def test_post_resolve_run_http(testdirectory):
    ...
    testdirectory.copy_file("test/post_resolve/resolve.json")
    ...
    assert testdirectory.contains_file("resolved_dependencies/baz-*/run-*/somefile.txt")

    assert testdirectory.contains_file("resolved_dependencies/baz-*/run-*/ok.txt")
